...
for subj in range(num_subject):
    ...
    for train_index, test_index in kf.split(Data):
        ...
        model.add(Flatten())
        model.add(Dense(900, activations='relu', use_bias=True))
        model.add(Dense(500, activations='relu', use_bias=True))
        model.add(Dense(200, activations='relu', use_bias=True))
        model.add(Dense(100, activations='relu', use_bias=True))
        model.add(Dense(40, activations='relu', use_bias=True))
        model.add(Dense(15, activations='relu', use_bias=True))
        model.add(Dense(5, activations='relu', use_bias=True))
